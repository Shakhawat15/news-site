<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
        ...
        <?php
          ...
          $sql = "SELECT post.post_id,post.title,post.post_date,post.category,post.post_img,category.category_name
          FROM post
          LEFT JOIN category ON post.category = category.category_id
          ORDER BY post.post_id DESC LIMIT {$limit}";

          $result = mysqli_query($conn, $sql) or die("Query Unseuccessful : Recent Post.");
